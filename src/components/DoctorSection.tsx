        ...
        >
          <div className="space-y-8">
            ...
            <motion.p 
              ...
              {...fadeInUp}
            >
              After months of unsuccessful self-treatment, I finally visited an experienced proctologist. The doctor carefully studied my situation and recommended an innovative solution - Vitacaps.
            </motion.p>
            ...
            >
              <img 
                ...
                alt="Vitacaps - Innovative Solution"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-sm font-medium text-center">Clinically Proven</span>
                </div>
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                ...
                <div className="flex flex-col items-center p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-sm font-medium text-center">Certified</span>
                </div>
              </div>
            </motion.div>
          </div>
